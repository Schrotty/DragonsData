 ...
 * Generated for Laravel 5.4.36 on 2017-10-08.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class App {
        ...
        {
            return Application::bootstrapPath($path);
        }
        ...
        {
            return Application::resolveProvider($provider);
        }
        ...
        {
            return Application::makeWith($abstract, $parameters);
        }
        ...
        {
            Application::provideFacades($namespace);
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            return Application::hasMethodBinding($method);
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            Application::bindMethod($method, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            return Application::callMethodBinding($method, $instance);
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            return Application::factory($abstract);
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            return Application::build($concrete);
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            return Application::getAlias($abstract);
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container            
            Application::forgetExtenders($abstract);
        }
